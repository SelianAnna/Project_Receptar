...
from .views import (
    ...
    IngredientListView, RecipeSearchView, RecipeUpdateView, RecipeDeleteView
)
...
urlpatterns = [
    ...
    path("<int:pk>/edit/", RecipeUpdateView.as_view(), name="edit"),      # NOVÉ
    path("<int:pk>/delete/", RecipeDeleteView.as_view(), name="delete"),  # NOVÉ
]